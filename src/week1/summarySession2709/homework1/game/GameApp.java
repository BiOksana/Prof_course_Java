package week1.summarySession2709.homework1.game;
...
//Метод fight() должен быть реализован с применением абстрактных методов
// countForce(), countProtectionLevel().
//При сражении побеждает персонаж, чья сила оказалась больше.
//У проигравшего персонажа отнимается здоровье пропорционально разнице сил и
// обратно пропорционально его защите
