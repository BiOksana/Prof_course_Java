...
//
//
//    Создать метод play(Creature another) так, чтобы все обитатели дома умели бы играть друг с другом.
//    При игре выводится сообщение о том, кто с кем играет. Доработать метод play() у подклассов так,
//    чтобы при попытке игры кошек с собаками:
...
//
//    У классов Cat и Robot добавить возможность поимки мышей, метод catchMouse() интерфейса CatchingSkills
